(()=>{
  ...
  const affectedPages=['affected.html','guide.html','shelters.html','terms.html','municipalities.html','municipality-updates.html','official.html','alert-channels.html','uto-waste.html','uto-housing.html','uto-repair.html','uto-bulletin.html'];
  ...
  if(path!=='index.html'){
    ...
    const detailParent=['kumamoto-support.html','uto-waste.html','uto-housing.html','uto-repair.html','uto-bulletin.html','hikawa-support.html','uki-support.html'].includes(path);

(()=>{
  ...
  const supportPages=['disaster.html','kumamoto-support.html','affected.html','guide.html','temporary-housing.html','shelters.html','terms.html','municipalities.html','municipality-updates.html','official.html','uto-waste.html','uto-housing.html','uto-repair.html','uto-bulletin.html','hikawa-support.html','hikawa-demolition.html','support.html','supporters.html','volunteer-centers.html','alert-channels.html'];
  ...
  if(path!=='index.html'){
    ...
    const detailParent=['kumamoto-support.html','uto-waste.html','uto-housing.html','uto-repair.html','uto-bulletin.html','hikawa-support.html','hikawa-demolition.html','uki-support.html'].includes(path);

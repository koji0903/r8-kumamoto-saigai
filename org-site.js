(()=>{
  ...
  if(path!=='index.html'){
    ...
    const detailParent=['kumamoto-support.html','uto-waste.html','uto-housing.html','uto-bulletin.html','hikawa-support.html','uki-support.html'].includes(path);

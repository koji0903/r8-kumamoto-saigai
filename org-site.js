(()=>{
  ...
  const activityPages=['timeline.html','meetings.html','official-timeline.html','official-water-recovery.html','official-response-tracks.html'];
  const organizationPages=['about.html','join.html','contact.html','privacy.html','accessibility.html'];
  const noMotionPages=['shelters.html','municipality-updates.html','timeline.html','meetings.html','official-timeline.html','official-water-recovery.html','official-response-tracks.html','volunteer-centers.html','privacy.html','accessibility.html','404.html','uto-waste.html'];

(()=>{
  ...
  const supportPages=['disaster.html','kumamoto-support.html','kumamoto-living-support.html','affected.html','guide.html','temporary-housing.html','shelters.html','terms.html','municipalities.html','municipality-updates.html','official.html','uto-waste.html','uto-housing.html','uto-repair.html','uto-support.html','uto-bulletin.html','uto-public-services.html','uto-jizokuka.html','uto-handbook.html','kumamoto-saishuppatsu.html','uki-einou-saikai.html','uki-support.html','uki-living-support.html','hikawa-support.html','hikawa-living-support.html','hikawa-demolition.html','yatsushiro-support.html','yatsushiro-living-support.html','support.html','supporters.html','volunteer-centers.html','alert-channels.html'];
  ...
  const activityPages=['timeline.html','meetings.html','official-timeline.html','official-water-recovery.html','official-response-tracks.html','hq-kumamoto.html','hq-yatsushiro.html','hq-uto.html'];
  ...
  const affectedPages=['affected.html','guide.html','shelters.html','terms.html','municipalities.html','municipality-updates.html','official.html','alert-channels.html','uto-waste.html','uto-housing.html','uto-repair.html','uto-bulletin.html','hikawa-demolition.html'];
  ...
  if(header){header.innerHTML=`<div class="org-header-inner"><a class="brand" href="index.html"><img class="org-logo" src="yokatai-logo.png" alt="一般社団法人よか隊ネット熊本"><span>熊本の地域と暮らしを支える<br><b>情報・支援プラットフォーム</b></span></a><button class="org-menu-toggle" type="button" aria-expanded="false" aria-controls="org-global-nav"><span aria-hidden="true"></span><b>メニュー</b></button><nav id="org-global-nav" aria-label="メインメニュー"><a class="org-nav-home" href="index.html"${currentAttr('home')}>ホーム</a><details class="org-nav-group org-nav-emergency${currentClass('support')}"><summary>令和8年熊本地震<span aria-hidden="true">⌄</span></summary><div class="org-mega-menu"><div class="org-mega-intro"><b>災害・支援情報</b><p>いま必要な情報を、目的から探せます。</p><a href="disaster.html">支援情報トップへ →</a></div><div class="org-mega-links"><a href="affected.html"><b>困りごとから探す</b><small>被災された方・ご家族へ</small></a><a href="shelters.html"><b>避難所を確認</b><small>開設中の施設と地図</small></a><a href="municipalities.html"><b>自治体別情報</b><small>お住まいの地域から探す</small></a><a href="official.html"><b>公的情報</b><small>国・県・市町村の発信</small></a><a href="supporters.html"><b>支援する方へ</b><small>支援方法・ボランティア</small></a><a href="volunteer-centers.html"><b>災害ボランティアセンター</b><small>各地の開設状況と募集</small></a><a href="alert-channels.html"><b>お知らせの受け取り方</b><small>公式LINE・メール・防災無線</small></a></div></div></details><a class="org-nav-reconstruction" href="reconstruction.html"${currentAttr('reconstruction')}>暮らしの再建</a><details class="org-nav-group${currentClass('activity')}"><summary>記録・資料<span aria-hidden="true">⌄</span></summary><div class="org-mega-menu org-mega-compact org-mega-records"><div class="org-mega-intro"><b>被災地の記録</b><p>原資料そのものと、そこから読み取れることの両方を置いています。</p></div><div class="org-mega-links"><b class="org-mega-head">原資料をたどる</b><a href="timeline.html"><b>日々の記録</b><small>状況と支援経過</small></a><a href="meetings.html"><b>火の国会議 議事録</b><small>会議記録と原本PDF</small></a><a href="municipalities.html"><b>自治体の対応記録</b><small>地域を選んで災害対策本部会議を見る</small></a><a href="municipalities.html?tab=updates"><b>市町村の公式発信</b><small>自治体発表を時系列で確認</small></a><a href="terms.html"><b>災害用語集</b><small>難しい言葉を調べる</small></a><b class="org-mega-head">発信から読み解く</b><a href="official-timeline.html"><b>被災地の局面</b><small>何が話題になっていたかの移り変わり</small></a><a href="official-water-recovery.html"><b>水の復旧</b><small>断水戸数に表れない水の問題</small></a><a href="official-response-tracks.html"><b>5つの対応の流れ</b><small>断水・罹災証明・災害VC・ごみ・相談</small></a></div></div></details><details class="org-nav-group${currentClass('organization')}"><summary>団体情報<span aria-hidden="true">⌄</span></summary><div class="org-mega-menu org-mega-compact org-mega-right"><div class="org-mega-intro"><b>よか隊ネット熊本</b><p>活動、連携、お問い合わせはこちら。</p></div><div class="org-mega-links"><a href="about.html"><b>私たちについて</b><small>理念・活動・団体概要</small></a><a href="join.html"><b>支援・協力する</b><small>一緒にできること</small></a><a href="contact.html"><b>お問い合わせ</b><small>メール・電話</small></a><a href="privacy.html"><b>プライバシーポリシー</b><small>個人情報の取り扱い</small></a></div></div></details></nav></div>`;
    ...
    emergencyMenu?.insertAdjacentHTML('beforebegin',`<a class="org-nav-portal" href="disaster.html"${currentAttr('portal')}>今必要な情報</a><a class="org-nav-audience org-nav-affected" href="affected.html"${currentAttr('affected')}><span>被災された方</span><small>困りごとから探す</small></a><a class="org-nav-region" href="municipalities.html"${path==='municipalities.html'?' aria-current="page"':''}>地域から探す</a><a class="org-nav-audience org-nav-supporters" href="supporters.html"${currentAttr('supporters')}><span>支援する方</span><small>活動前に確認</small></a>`);
  ...
  if(path!=='index.html'){
    ...
    const detailParent=['kumamoto-support.html','uto-waste.html','uto-housing.html','uto-repair.html','uto-support.html','uto-bulletin.html','uto-public-services.html','hikawa-support.html','hikawa-demolition.html','uki-support.html'].includes(path);

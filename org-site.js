(()=>{
  ...
  if(path!=='index.html'){
    ...
    const detailParent=['kumamoto-support.html','uto-waste.html','uto-housing.html','uto-repair.html','uto-support.html','uto-bulletin.html','hikawa-support.html','hikawa-demolition.html','uki-support.html'].includes(path);

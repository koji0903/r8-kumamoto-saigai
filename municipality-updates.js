(() => {
  ...
  const renderTimeline = (refreshFilters = true) => {
    ...
    if (municipality.name === "宇土市") {
      $("#feedMunicipalityHeader").insertAdjacentHTML("afterend", `<a class="municipality-feature feed-special-link" href="uto-bulletin.html"><span class="municipality-feature-icon" aria-hidden="true"><svg viewBox="0 0 24 24"><path d="M5 3h11l3 3v15H5Z"/><path d="M9 8h6M9 12h6M9 16h4"/></svg></span><span><small>被災された方へ</small><b>広報うと 災害臨時号vol.1</b><em>市の広報紙にまとめられた制度・窓口・期限を分かりやすく確認</em></span><i>案内を見る →</i></a><a class="municipality-feature feed-special-link" href="uto-waste.html"><span class="municipality-feature-icon" aria-hidden="true"><svg viewBox="0 0 24 24"><path d="M4 7h16v13H4zM8 7V4h8v3M9 11v5m6-5v5"/></svg></span><span><small>被災された方へ</small><b>災害ごみの持ち込み案内</b><em>品目別の持込先・入場券・地図を分かりやすく確認</em></span><i>案内を見る →</i></a>`);
    }

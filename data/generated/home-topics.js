...
window.HOME_TOPICS = {
  ...
  "siteTopics": [
    ...
    },
    {
      ...
      "category": "八代市",
      "badge": "事業者支援・12/17締切",
      "title": "八代市：セーフティネット保証4号（別枠無担保8,000万円・100%信用保証）利用ガイドを公開",
      "url": "yatsushiro-safetynet4.html",
      "description": "八代市が令和8年熊本地震の被災事業者に実施する「セーフティネット保証4号」の公式発表を詳細分析。一般保証とは別枠無担保8,000万円・100%全額保証の仕組みや八代市が国に指定された背景、売上20%以上減要件の3パターン診断シミュレーター、認定書発行から金融機関融資申込みまでの手順、申請書類ダウンロードを整理しました。",
      "targetPage": "yatsushiro-safetynet4.html"
    },
    {
      "date": "2026-09-17",
      "category": "地域横断",
      "badge": "5市町・全20制度比較",
      "title": "熊本市・宇土市・宇城市・氷川町・八代市「災害支援制度のまとめ・比較」を公開",
      "url": "priority-support-summary.html",
      "description": "熊本市および重点被災4市町（宇土市・宇城市・氷川町・八代市）の5自治体における災害支援制度を横断比較。住まい（再建支援金・応急修理・仮設・公費解体等）、生活資金（災害援護資金・社協貸付・見舞金等）、税・保険料減免、片づけ（災害ごみ・井戸・二次避難等）、事業者・農業支援の全20制度について、制度の有無・金額・条件・特設ガイド・自治体公式の受付状況を分かりやすく整理しました。",
      "targetPage": "priority-support-summary.html"
    },
    {
      "date": "2026-09-17",
      "category": "八代市",
      "badge": "公的貸付・11/2申請締切",
      "title": "八代市：災害援護資金の貸付（最大350万円・条件付無利子）利用ガイドを公開",
      "url": "yatsushiro-loan.html",
      "description": "八代市が令和8年熊本地震の被災世帯へ実施する「八代市災害援護資金貸付」の公式案内を詳細分析。世帯主の負傷や住居・家財損害に応じた限度額診断シミュレーター、保証人ありで全期間無利子（0％）、据置最長5年・償還10年、住居滅失時の所得制限緩和（1,270万円）、必要書類チェックリスト、本庁2階窓口案内を整理しました。",
      "targetPage": "yatsushiro-loan.html"
    },
    {
      "date": "2026-09-17",
      "category": "宇土市",
      "badge": "国補助事業・9/16受付開始",
      "title": "宇土市：小規模事業者持続化補助金＜災害支援枠（令和8年熊本地震）＞利用ガイドを公開",
      "url": "uto-jizokuka.html",
      "description": "宇土市および全国商工会連合会が受付を開始した「小規模事業者持続化補助金（一般型 災害支援枠）」の公式公募要領・案内PDFを詳細分析。直接被害最大200万円（定額10/10あり）・間接被害最大100万円の受給額診断、商工会確認書（10/9締切）・公募締切（10/16）、対象経費・活用事例、完全後払いや罹災証明書取得の3大鉄則をまとめました。",
      "targetPage": "uto-jizokuka.html"
    }
  ],
  "municipalityUpdates": [
    {

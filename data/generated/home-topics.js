...
window.HOME_TOPICS = {
  ...
  "siteTopics": [
    ...
    },
    {
      ...
      "description": "氷川町の特有制度（町内産畳表張替助成最大10万円、すこやか赤ちゃん出産祝金最大10万円、高校生医療費助成、移住体験住宅、移住支援金100万円等）と、熊本地震特別支援（公費解体・自費解体費用助成、住宅耐震化最大100万円、応急修理最大75.7万円等）を条件で横断検索できる総合ガイドを公開しました。",
    ...
    },
    {
      ...
      "description": "宇城市の手厚い制度（高校生までの医療費完全無償化、児童手当、出産応援10万円、結婚新生活支援最大60万円、小川ラボ創業支援、移住支援金最大100万円、在宅要介護住宅改造助成等）と、熊本地震特別支援（被災者生活再建支援金最大300万円、無料相談会、耐震改修最大100万円等）を瞬時に絞り込める総合ガイドを公開しました。",

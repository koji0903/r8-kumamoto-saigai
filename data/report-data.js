window.REPORT_DATA = {
  ...
  municipalEvents: [
    ...
    {
      date: "2026-08-21", meeting: 514, page: 2, category: "住まい",
      areas: ["熊本市", "八代市", "宇土市", "宇城市", "美里町", "甲佐町", "氷川町"],
      title: "建設型応急住宅は15団地318戸へ", detail: "熊本市50戸、八代市104戸、宇土市17戸、宇城市50戸、美里町52戸、甲佐町20戸、氷川町75戸の整備状況が報告されました。",
      pdf: "sources/hinokuni-meetings/20260821火の国会議514回.pdf"
    },
    {
      date: "2026-08-21", meeting: 514, page: 2, category: "生活支援",
      areas: ["熊本市", "宇土市", "宇城市", "八代市", "氷川町", "甲佐町", "美里町", "御船町", "嘉島町", "益城町"],
    ...
    { date:"2026-09-15", meeting:527, page:4, category:"住まい", areas:["熊本市","八代市","宇土市","宇城市","美里町","甲佐町","氷川町"], title:"建設型応急住宅は22団地614戸へ", detail:"美里町72戸、甲佐町30戸へ増工。氷川町吉本20戸（9/5）、鹿島18戸（9/10）が入居開始。八代・氷川で2階建て仮設も着工。", pdf:"sources/hinokuni-meetings/20260915火の国会議527回.pdf" },
    { date:"2026-09-18", meeting:528, page:4, category:"住まい", areas:["熊本市","八代市","宇土市","宇城市","美里町","甲佐町","氷川町"], title:"建設型応急住宅は25団地700戸へ", detail:"熊本市50戸（9/19入居）、八代市242戸など7市町700戸へ拡大。氷川町では自宅敷地内への建設型仮設工事に着手。", pdf:"sources/hinokuni-meetings/20260918火の国会議528回.pdf" },
    { date:"2026-09-22", meeting:529, page:4, category:"住まい", areas:["宇城市"], title:"宇城市当尾仮設団地が入居開始へ", detail:"宇城市の建設型仮設（第一期50戸）のうち当尾仮設が9月23日から入居開始。7市町で700戸の整備が進む。", pdf:"sources/hinokuni-meetings/20260922火の国会議529回.pdf" }
  ],
  supportCategories: [
  ...
  supportEvents: [
    ...
    { date:"2026-08-20", meeting:513, page:7, category:"shelter", title:"把握しにくい車中泊・在宅避難者を確認", detail:"車中泊者は減少して見える一方、自宅敷地内など把握しにくい場所に残り、高齢者、外国人技能実習生、大人数世帯などに住まい確保の課題があると報告されました。", areas:["宇城市","氷川町"], pdf:"sources/hinokuni-meetings/20260820火の国会議513回.pdf" },
    { date:"2026-08-21", meeting:514, page:8, category:"materials", title:"氷川町6か所へ1,190食を提供", detail:"8月20日に6団体が6か所へ計1,190食を提供したとPBVから報告されました。", areas:["氷川町"], pdf:"sources/hinokuni-meetings/20260821火の国会議514回.pdf" },
    { date:"2026-08-21", meeting:514, page:13, category:"access", title:"日中に物資を受け取れない世帯などの課題", detail:"氷川町で、ひとり親世帯が日中に支援物資を受け取れないことや、学校・学童再開後の子どもと保護者のストレスが共有されました。", areas:["氷川町"], pdf:"sources/hinokuni-meetings/20260821火の国会議514回.pdf" },
    ...
    { date:"2026-09-15", meeting:527, page:6, category:"volunteer", title:"災害VCは熊本市が週末型へ移行、八代・宇城・氷川は毎日型継続", detail:"熊本市は残ニーズ減で9/22から週末型へ。八代市はSWに各日300人以上受付。累計ボランティア26,134人、完了4,860件。", areas:["熊本市","八代市","宇城市","氷川町"], pdf:"sources/hinokuni-meetings/20260915火の国会議527回.pdf" },
    { date:"2026-09-15", meeting:527, page:8, category:"housing", title:"八代市避難所で住まい意向調査を開始", detail:"避難所14か所の避難者を中心に市が意向調査を開始。次の暮らしへの移行期に生活再建の希望把握と制度案内が重要。", areas:["八代市"], pdf:"sources/hinokuni-meetings/20260915火の国会議527回.pdf" },
    { date:"2026-09-15", meeting:527, page:15, category:"housing", title:"公費解体の部分解体ルールと残置物配慮を共有", detail:"登記・構造上別棟なら増築部を残して解体可能。自力で搬出できない思い出の品や貴重品は事業者ができる限り配慮する通知を周知。", areas:[], pdf:"sources/hinokuni-meetings/20260915火の国会議527回.pdf" },
    { date:"2026-09-18", meeting:528, page:7, category:"volunteer", title:"災害VCは美里・御船が閉所し7市町で稼働", detail:"美里町・御船町が9月18日閉所。熊本市は週末型、益城・甲佐は随時型へ移行。累計ボランティア約27,500人。", areas:["美里町","御船町","熊本市","益城町","甲佐町"], pdf:"sources/hinokuni-meetings/20260918火の国会議528回.pdf" },
    { date:"2026-09-18", meeting:528, page:8, category:"shelter", title:"八代市避難所で生活再建の意向調査を継続", detail:"住まいの不安を抱える避難者に対し、関係団体が連携して意向把握と支援制度への接続を推進。", areas:["八代市"], pdf:"sources/hinokuni-meetings/20260918火の国会議528回.pdf" },
    { date:"2026-09-18", meeting:528, page:15, category:"housing", title:"被災住宅相談会を八代・宇土で開催", detail:"建築士による無料相談会を実施。八代市役所（木曜）、宇土市役所（9/28〜）で復旧・耐震・再建の技術相談に対応。", areas:["八代市","宇土市"], pdf:"sources/hinokuni-meetings/20260918火の国会議528回.pdf" },
    { date:"2026-09-22", meeting:529, page:8, category:"children", title:"被災した子どもの放課後活動・学習支援を継続", detail:"児童館支援や移動児童館を展開。宇城市等で小学生向け居場所づくりや学習支援が進められています。", areas:["宇城市"], pdf:"sources/hinokuni-meetings/20260922火の国会議529回.pdf" },
    { date:"2026-09-22", meeting:529, page:11, category:"welfare", title:"不知火体育館でペット同行避難を受入れ", detail:"宇城市不知火体育館で犬・猫の同行避難に対応し、隣接施設で一時預かりデイを運営。八代市等でも個別支援を連携。", areas:["宇城市","八代市"], pdf:"sources/hinokuni-meetings/20260922火の国会議529回.pdf" },
    { date:"2026-09-22", meeting:529, page:13, category:"housing", title:"緊急修理制度の受付期間を全市町村で10/27まで延長", detail:"住宅の緊急修理受付を10月27日まで延長（熊本市除く）。屋根ブルーシート土のうの劣化対策や部分解体ルールを周知。", areas:[], pdf:"sources/hinokuni-meetings/20260922火の国会議529回.pdf" }
  ],
  metrics: [
  ...
  days: [
    ...
    {
      date: "2026-08-19", meeting: 512, disasterDay: 23, attendees: 96,
      pdf: "sources/hinokuni-meetings/20260819火の国会議512回.pdf",
      areas: ["熊本市", "八代市", "宇土市", "宇城市", "上天草市", "美里町", "御船町", "嘉島町", "益城町", "甲佐町", "氷川町", "芦北町"],
      stats: {
        injured: 399, deaths: 39,
        evacuees: 2966, shelters: 69,
        outages: null, outageStatus: "おおむね解消",
        homes: 33769, waterOutages: 4890,
        waterOutageAreas: ["宇城市", "八代市", "氷川町"]
      },
      topics: ["被害", "避難", "断水", "住まい", "証明", "ボランティア", "車中泊", "食事", "子ども", "物資", "要配慮者", "外国人", "ペット", "家屋保全"],
      headline: "断水は4,890戸へ、ボランティア参加は累計1万人を超える",
      summary: "断水は宇城・八代・氷川の3市町で4,890戸、避難者は2,966人となりました。災害ボランティアの参加は累計1万人を超えた一方、八代市では残るニーズが2,000件を超え、長期的な運営が見込まれています。",
      actions: [
        "8月20日から車中泊健康相談ダイヤルを開設",
        "八代市・宇土市・宇城市・氷川町の災害VCは長期的な運営を見込む",
        "宇城市のコンビニ2店舗と災害VCへ自律型トイレ支援を決定"
      ],
      note: "被害統計は8月19日の第25回熊本県災害対策本部会議資料。人的被害399人は死亡39人を含む総数で、住家被害33,769棟は推定値、断水4,890戸は宇城市・八代市・氷川町の3市町合計です。"
    },
    {
      date: "2026-08-20", meeting: 513, disasterDay: 24, attendees: 95,
      pdf: "sources/hinokuni-meetings/20260820火の国会議513回.pdf",
      areas: ["熊本市", "八代市", "宇土市", "宇城市", "上天草市", "美里町", "御船町", "嘉島町", "益城町", "甲佐町", "氷川町", "芦北町"],
      stats: { injured: 399, deaths: 39, evacuees: 2966, shelters: 69, outages: null, outageStatus: "おおむね解消", homes: 33769, waterOutages: 4890, waterOutageAreas: ["宇城市", "八代市", "氷川町"] },
      topics: ["避難", "断水", "住まい", "証明", "ボランティア", "車中泊", "食事", "子ども", "物資", "要配慮者", "外国人", "ペット", "家屋保全"],
      headline: "見えにくい避難者の住まい確保と長期支援を共有",
      summary: "県の被害統計は8月19日時点を継続掲載しました。車中泊者は減ったように見える一方、自宅敷地内などに残る人は把握しにくく、高齢者、外国人技能実習生、大人数世帯などに住まい確保の課題があると報告されました。",
      actions: ["熊本市災害VCを8月24日から南区拠点へ集約", "関東ブロックが8月22日から宇土市災害VCを支援", "8月30日に氷川町で多言語相談会を開催"],
      note: "被害統計は8月19日の第25回熊本県災害対策本部会議資料を再掲しています。"
    },
    {
      date: "2026-08-21", meeting: 514, disasterDay: 25, attendees: 95,
      pdf: "sources/hinokuni-meetings/20260821火の国会議514回.pdf",
      areas: ["熊本市", "八代市", "宇土市", "宇城市", "上天草市", "美里町", "御船町", "嘉島町", "益城町", "甲佐町", "氷川町", "芦北町"],
      stats: { injured: 399, deaths: 38, evacuees: 2884, shelters: 69, outages: null, outageStatus: "おおむね解消", homes: 36784, waterOutages: 4050, waterOutageAreas: ["宇城市", "八代市", "氷川町"] },
      topics: ["被害", "避難", "断水", "住まい", "証明", "ボランティア", "食事", "子ども", "物資", "要配慮者", "外国人", "ペット", "家屋保全"],
      headline: "断水4,050戸、応急住宅は15団地318戸へ",
      summary: "断水は4,050戸、避難者は2,884人となりました。建設型応急住宅は7市町15団地318戸へ拡大し、公費解体は特例として半壊も対象に含める方針が示されました。人的被害の総数399人は変わらず、死者数は調査中の見直しにより39人から38人へ訂正されています。",
      actions: ["公費解体は半壊も対象とし県庁内に支援チームを設置", "緊急小口資金の特例貸付を市町村社協で受付", "災害ごみ仮置場の閉鎖日とVC活動日の調整を継続"],
      note: "被害統計は8月21日の第26回熊本県災害対策本部会議資料。表紙の参加者数は会場1人・オンライン70人・合計95人で、内訳の和と合計が一致しないため合計欄を採用しています。"
    },
    {
      date: "2026-08-22", meeting: 515, disasterDay: 26, attendees: 68,
      pdf: "sources/hinokuni-meetings/20260822火の国会議515回.pdf",
      areas: ["熊本市", "八代市", "宇土市", "宇城市", "美里町", "御船町", "嘉島町", "益城町", "甲佐町", "氷川町", "芦北町"],
      stats: { injured: 399, deaths: 38, evacuees: 2884, shelters: 69, outages: null, outageStatus: "おおむね解消", homes: 36784, waterOutages: 4050, waterOutageAreas: ["宇城市", "八代市", "氷川町"] },
      topics: ["避難", "断水", "住まい", "証明", "ボランティア", "車中泊", "食事", "子ども", "物資", "要配慮者", "外国人", "ペット", "家屋保全"],
      headline: "八代市の避難所環境改善と罹災証明申請支援を共有",
      summary: "県の被害統計は8月21日時点を継続掲載しました。八代市では避難所へのマットレス・シーツ導入がほぼ完了し、高齢者などが罹災証明書を申請する際の行政書士会による無料支援も共有されました。災害ボランティア参加者は累計1万1千人を超えています。",
      actions: ["八代市災害VCの現地調査に建築士が同行", "行政書士会が罹災証明書のオンライン・代理申請を無料支援", "八代市の避難所へマットレスとシーツを搬入"],
      note: "被害統計は8月21日の第26回熊本県災害対策本部会議資料を再掲しています。"
    },
    {
      date: "2026-08-24", meeting: 516, disasterDay: 28, attendees: 71,
      pdf: "sources/hinokuni-meetings/20260824火の国会議516回.pdf",
      areas: ["熊本市", "八代市", "宇土市", "宇城市", "美里町", "御船町", "嘉島町", "益城町", "甲佐町", "氷川町", "芦北町"],
      stats: { injured: 399, deaths: 38, evacuees: 2884, shelters: 69, outages: null, outageStatus: "おおむね解消", homes: 36784, waterOutages: 4050, waterOutageAreas: ["宇城市", "八代市", "氷川町"] },
      topics: ["避難", "断水", "住まい", "証明", "ボランティア", "車中泊", "食事", "子ども", "物資", "要配慮者", "外国人", "ペット", "家屋保全"],
      headline: "住まいの相談窓口を開設、応急住宅は18団地368戸へ",
      summary: "県の被害統計は8月21日時点を継続掲載しました。建設型応急住宅は7市町18団地368戸となり、8月25日から住まいのサポートダイヤルが開設されます。車中泊支援は宇城・氷川・八代周辺で1日6〜7台程度と報告されました。",
      actions: ["8月25日に住まいのサポートダイヤルを開設", "御船町が9月から住家被害認定調査へ建築士派遣を依頼", "八代市災害VCの安全確認に建築士が継続協力"],
      note: "被害統計は8月21日の第26回熊本県災害対策本部会議資料を再掲しています。8月23日に火の国会議は開催されていません。"
    },
    {
      date: "2026-08-25", meeting: 517, disasterDay: 29, attendees: 80,
      pdf: "sources/hinokuni-meetings/20260825火の国会議517回.pdf",
      areas: ["熊本市", "八代市", "宇土市", "宇城市", "美里町", "御船町", "嘉島町", "益城町", "甲佐町", "氷川町", "芦北町"],
      stats: { injured: 402, deaths: 38, evacuees: 2635, shelters: 65, outages: null, outageStatus: "おおむね解消", homes: 39247, waterOutages: 2320, waterOutageAreas: ["宇城市", "八代市", "氷川町"] },
      topics: ["被害", "避難", "断水", "住まい", "証明", "ボランティア", "車中泊", "食事", "物資", "要配慮者", "外国人", "ペット", "家屋保全"],
      headline: "断水2,320戸、応急住宅は19団地409戸へ",
      summary: "断水は宇城・八代・氷川の3市町で2,320戸、避難者は2,635人となりました。建設型応急住宅は7市町19団地409戸へ拡大。罹災証明書の申請は60,362件、交付は22,641件です。",
      actions: ["8月25日に住まいのサポートダイヤルを開設", "嘉島町災害VCは8月31日閉所、最後の活動は8月28日を予定", "9月から八代・宇城・氷川方面の災害ボランティアバスを運行"],
      note: "被害統計は8月25日の第27回熊本県災害対策本部会議資料。避難所65か所・避難者2,635人は11市町の合計で、把握できている車中泊者を含みます。"
    },
    {
      date: "2026-08-26", meeting: 518, disasterDay: 30, attendees: 62,
      pdf: "sources/hinokuni-meetings/20260826火の国会議518回.pdf",
      areas: ["熊本市", "八代市", "宇土市", "宇城市", "美里町", "御船町", "嘉島町", "益城町", "甲佐町", "氷川町", "芦北町"],
      stats: { injured: 402, deaths: 38, evacuees: 2635, shelters: 65, outages: null, outageStatus: "おおむね解消", homes: 39247, waterOutages: 2320, waterOutageAreas: ["宇城市", "八代市", "氷川町"] },
      topics: ["避難", "断水", "住まい", "証明", "ボランティア", "食事", "子ども", "物資", "要配慮者", "外国人", "ペット", "家屋保全"],
      headline: "通院・入浴の移動支援と地域支え合い体制が課題",
      summary: "宇城市豊野では診療所の被災により、車がない人の通院支援が必要と報告されました。八代市の避難所では入浴サービスへの移動が課題です。21市町村を対象に地域支え合いセンター開設に向けた説明会も開かれました。",
...
,
    ...
    {
      date: "2026-09-15", meeting: 527, disasterDay: 50, attendees: 76,
      pdf: "sources/hinokuni-meetings/20260915火の国会議527回.pdf", areas: ["熊本市", "八代市", "宇土市", "宇城市", "美里町", "甲佐町", "氷川町", "益城町", "嘉島町", "御船町", "芦北町"],
      stats: { injured: 407, deaths: 38, evacuees: 1771, shelters: 37, outages: null, outageStatus: "水道本管は応急復旧", homes: 68851, waterOutages: 0, waterOutageAreas: [] },
      topics: ["被害", "避難", "住まい", "証明", "ボランティア", "物資", "要配慮者", "外国人", "ペット", "家屋保全"],
      headline: "仮設住宅614戸へ拡大、避難所では住まい意向調査が進む",
      summary: "建設型応急住宅は614戸へ増え、氷川町では鹿島仮設18戸も入居を開始しました。八代市の避難所では市による住まい意向調査が始まり、公費解体の部分解体や残置物の扱いなど個別判断の支援が焦点となっています。",
      actions: ["八代市等の避難所で住まい意向調査", "熊本市災害VCが9月22日から週末型へ移行", "公費解体の部分解体・残置物配慮の通達を共有"], note: "被害統計は9月11日の第3回復旧・復興本部会議資料。住家被害は県公式資料の合計68,851棟を採用（火の国会議資料は68,858棟と記載）。住家被害は推定値。断水0戸は水道本管の応急復旧に関する扱いで、井戸等の個別課題は継続しています。"
    },
    {
      date: "2026-09-18", meeting: 528, disasterDay: 53, attendees: 63,
      pdf: "sources/hinokuni-meetings/20260918火の国会議528回.pdf", areas: ["熊本市", "八代市", "宇土市", "宇城市", "美里町", "甲佐町", "氷川町", "益城町", "嘉島町", "御船町", "芦北町", "合志市", "上天草市"],
      stats: { injured: 408, deaths: 38, evacuees: 1626, shelters: 36, outages: null, outageStatus: "水道本管は応急復旧", homes: 70086, waterOutages: 0, waterOutageAreas: [] },
      topics: ["被害", "避難", "住まい", "証明", "ボランティア", "車中泊", "物資", "要配慮者", "子ども", "家屋保全"],
      headline: "仮設住宅700戸へ拡大、災害VCは美里・御船が閉所し7市町へ",
      summary: "建設型応急住宅は25団地700戸へ拡大し、熊本市で9月19日から入居開始となります。災害VCは美里町・御船町が閉所して7市町体制となり、避難者の住まい意向調査や地域支え合いセンターへの移行が進んでいます。",
      actions: ["熊本市で仮設住宅50戸が入居開始", "美里町・御船町の災害VC閉所に伴い地域支援へ移行", "氷川町で自宅敷地内への建設型仮設設置に着手"], note: "被害統計は9月18日の第4回復旧・復興本部会議資料。住家被害は推定値。断水0戸は水道本管の応急復旧に関する扱いで、井戸等の個別課題は継続しています。"
    },
    {
      date: "2026-09-22", meeting: 529, disasterDay: 57, attendees: 43,
      pdf: "sources/hinokuni-meetings/20260922火の国会議529回.pdf", areas: ["熊本市", "八代市", "宇土市", "宇城市", "美里町", "甲佐町", "氷川町", "益城町", "嘉島町", "御船町", "芦北町", "合志市", "上天草市"],
      stats: { injured: 408, deaths: 38, evacuees: 1626, shelters: 36, outages: null, outageStatus: "水道本管は応急復旧", homes: 70086, waterOutages: 0, waterOutageAreas: [] },
      topics: ["被害", "避難", "住まい", "証明", "ボランティア", "子ども", "ペット", "家屋保全"],
      headline: "緊急修理制度を10月27日まで延長、宇城市当尾仮設が入居開始へ",
      summary: "被災住宅の緊急修理制度の受付期間が10月27日まで延長（熊本市除く）されました。宇城市当尾仮設団地が9月23日に入居を開始し、屋根ブルーシートの劣化対策や部分解体ルールの周知、子どもの放課後支援などが共有されました。",
      actions: ["緊急修理制度の受付期間を10月27日まで延長", "宇城市当尾仮設団地が入居開始", "屋根ブルーシートの土のう劣化対策を共有"], note: "被害統計は9月18日の第4回復旧・復興本部会議資料。住家被害は推定値。断水0戸は水道本管の応急復旧に関する扱いで、井戸等の個別課題は継続しています。"
    }  ]
};

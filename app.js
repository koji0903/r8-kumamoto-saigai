...
if($("#municipalityDetail")){
  const municipalityPages={
    ...
    "宇城市":{support:[["uki-living-support.html","暮らしの支援・補助金 総合ガイド","住まい・子育て（医療無償化）・福祉・移住・創業を条件から探す"],["https://labs-dr.bosai.go.jp/uki/shien-navi","うき支援ナビ（市公式）","困りごと・判定・キーワードから支援検索（サポートダイヤル 0964-27-8002）",true],["uki-support.html","被災者支援制度ガイド","証明・住まい・お金・健康・片づけ・減免"]]},

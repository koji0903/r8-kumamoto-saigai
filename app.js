...
if($("#municipalityDetail")){
  const municipalityPages={
    "熊本市":{support:[["kumamoto-support.html","被災者支援制度ガイド","証明・お金・住まい・生活・減免・事業を困りごとから確認"],["kumamoto-living-support.html","暮らしの支援・補助金 総合ガイド","住まい（耐震・空き家）・子育て（高校生医療費・保育料無償化）・福祉・地域・創業を条件から探す"]],records:[["hq-kumamoto.html","災害対策本部会議","市の対応と被害・避難の推移"]]},
    "八代市":{support:[["yatsushiro-support.html","被災者応援ガイドブック（第7版）","全54制度を対象・金額・期限・条件・必要書類から確認"],["yatsushiro-living-support.html","暮らしの支援・補助金 総合ガイド","住まい（八代産材）・子育て（高校生医療費・保育料無償化）・福祉・移住・創業を条件から探す"]],records:[["hq-yatsushiro.html","災害対策本部会議","市の対応と被害・避難の推移"]]},
    "宇土市":{support:[["uto-handbook.html","被災者支援制度ハンドブック 全69制度","市公式ハンドブックの全制度を判定・困りごと・種類から検索"],["uto-support.html","暮らしの支援・補助金 総合ガイド","住まい・子育て・健康・福祉・産業・特別支援を条件から探す"],["uto-public-services.html","公的施設・市民サービス マップ","市役所・支所・警察・上下水道・ごみ処理・保健所・包括支援など全39施設"],["uto-housing.html","住まいの相談・再建支援","応急修理・みなし仮設・相談窓口"],["uto-repair.html","住宅の応急修理ガイド","対象・上限額・対象になる修理・写真・書類・流れ"],["uto-waste.html","災害ごみの持ち込み","ごみの種類、持込先、入場券配布場所"],["uto-bulletin.html","広報うと 災害臨時号","期限のある手続きと支援制度"]],records:[["hq-uto.html","災害対策本部会議","全公開資料から市の対応をたどる"]]},
    "宇城市":{support:[["uki-living-support.html","暮らしの支援・補助金 総合ガイド","住まい・子育て（医療無償化）・福祉・移住・創業を条件から探す"],["https://labs-dr.bosai.go.jp/uki/shien-navi","うき支援ナビ（市公式）","困りごと・判定・キーワードから支援検索（サポートダイヤル 0964-27-8002）",true],["uki-support.html","被災者支援制度ガイド","証明・住まい・お金・健康・片づけ・減免"],["uki-einou-saikai.html","営農再開支援事業（ハード事業）","被災した農業用機械・ハウス・畜舎の修繕／再取得を9/10〜7/10で補助"]]},
    "氷川町":{support:[["hikawa-living-support.html","暮らしの支援・補助金 総合ガイド","住まい（畳表張替・耐震）・子育て・福祉・移住・産業を条件から探す"],["https://hikawa-shien-torisetsu.jp/","被災者支援のトリセツ（町公式）","申請期限つきで制度・窓口を検索・案内（フリーダイヤル 0120-091-110）",true],["hikawa-support.html","被災者支援制度一覧","証明書・住まい・支援金・毎日の生活"],["hikawa-demolition.html","被災家屋等の公費解体・自費解体ガイド","全壊〜半壊の申請手続き・予約電話・必要書類10点・自費解体"]]}
  };
  ...
  const renderDetail=()=>{
    ...
    if(selectedMunicipality==="氷川町")document.querySelector(".municipality-reconstruction-entry")?.insertAdjacentHTML("afterend",`<div class="municipality-feature-list"><a class="municipality-feature municipality-feature-official" href="https://hikawa-shien-torisetsu.jp/" target="_blank" rel="noopener"><span class="municipality-feature-icon" aria-hidden="true"><svg viewBox="0 0 24 24"><path d="M18 13v6a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h6"/><polyline points="15 3 21 3 21 9"/><line x1="10" y1="14" x2="21" y2="3"/></svg></span><span><small>氷川町 公式サービス</small><b>被災者支援のトリセツ ↗</b><em>申請期限つき支援制度検索・相談窓口（フリーダイヤル 0120-091-110）</em></span><i>開く ↗</i></a><a class="municipality-feature" href="hikawa-support.html"><span class="municipality-feature-icon" aria-hidden="true"><svg viewBox="0 0 24 24"><path d="M6 3h9l3 3v15H6z"/><path d="M9 10h6M9 14h6M9 18h4"/></svg></span><span><small>氷川町｜被災された方へ</small><b>支援制度一覧</b><em>証明書・住まい・支援金・毎日の生活を目的から確認</em></span><i>案内を見る →</i></a></div>`);
    if(selectedMunicipality==="宇城市")document.querySelector(".municipality-reconstruction-entry")?.insertAdjacentHTML("afterend",`<div class="municipality-feature-list"><a class="municipality-feature municipality-feature-official" href="https://labs-dr.bosai.go.jp/uki/shien-navi" target="_blank" rel="noopener"><span class="municipality-feature-icon" aria-hidden="true"><svg viewBox="0 0 24 24"><path d="M18 13v6a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h6"/><polyline points="15 3 21 3 21 9"/><line x1="10" y1="14" x2="21" y2="3"/></svg></span><span><small>宇城市 公式サービス（防災科研連携）</small><b>うき支援ナビ ↗</b><em>困りごと・判定・キーワードから支援検索（サポートダイヤル 0964-27-8002）</em></span><i>開く ↗</i></a><a class="municipality-feature" href="uki-support.html"><span class="municipality-feature-icon" aria-hidden="true"><svg viewBox="0 0 24 24"><path d="M6 3h9l3 3v15H6z"/><path d="M9 10h6M9 14h6M9 18h4"/></svg></span><span><small>宇城市｜被災された方へ</small><b>被災者支援制度ガイド</b><em>36の制度を、証明・住まい・お金・健康・片づけ・減免から確認</em></span><i>案内を見る →</i></a></div>`);

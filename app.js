...
if($("#municipalityDetail")){
  const municipalityPages={
    ...
    "宇土市":{support:[["uto-support.html","暮らしの支援・補助金 総合ガイド","住まい・子育て・健康・福祉・産業・特別支援を条件から探す"],["uto-public-services.html","公的施設・市民サービス マップ","市役所・支所・子育て・保健・福祉・公民館・体育館など全27施設"],["uto-housing.html","住まいの相談・再建支援","応急修理・みなし仮設・相談窓口"],["uto-repair.html","住宅の応急修理ガイド","対象・上限額・対象になる修理・写真・書類・流れ"],["uto-waste.html","災害ごみの持ち込み","ごみの種類、持込先、入場券配布場所"],["uto-bulletin.html","広報うと 災害臨時号","期限のある手続きと支援制度"]],records:[["hq-uto.html","災害対策本部会議","全公開資料から市の対応をたどる"]]},

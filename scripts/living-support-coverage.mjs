...
const CURATED_NAVIGATION = /^(移住定住情報|空き家バンク|お知らせ|新着情報|支援制度一覧|支援制度について|移住相談・定住支援|登録物件情報|イベントカレンダー(から)?|申請書(ダウンロード|検索)|組織から|分類から|サイトマップから|ライフイベントから|ランキングから|前の記事へ|次の記事へ|町の紹介|市の紹介|プライバシーポリシー|アクセシビリティ|Foreign Language|消費生活センター|.*公共交通|医療機関.*事業所|ホームページについて|過去のサイト|市役所へのアクセス|組織一覧.*|窓口の受付時間変更について|著作権・リンク・免責事項|庁舎フロア案内図|例規・要綱|休日当番医)$/;

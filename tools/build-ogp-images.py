...
PAGES = [
    ...
    dict(file="uto-handbook.html", out="ogp-uto-handbook.png", tone="amber", art="guide_book",
         label="宇土市", tag="支援制度ハンドブック",
         target="宇土市で被災されたすべての方・支援に入る方",
         title="被災者支援制度ハンドブック/全69制度をすぐ探せる検索ガイド",
         lead="市公式ハンドブック全75ページの69制度を収録。り災判定・困りごと・支援の種類で絞り込み。期限12件と担当課の直通番号も掲載。",
         chips=["全69制度を収録", "判定・困りごとで検索", "期限と直通番号つき"]),
    dict(file="uki-einou-saikai.html", out="ogp-uki-einou-saikai.png", tone="green", art="agri",
         label="宇城市", tag="被災農業者支援",
         target="被災した宇城市の農業者・農業者団体",
         title="営農再開支援事業（ハード事業）/農業用機械・ハウス復旧ガイド",
         lead="機械・畜舎の修繕／再取得は9/10、ハウス等は7/10、補強7/10、撤去8/10。7月28日以降の事前着工も対象。説明会日程と必要書類を整理。",
         chips=["補助率9/10〜7/10", "事前着工が対象", "必要書類チェックリスト"]),

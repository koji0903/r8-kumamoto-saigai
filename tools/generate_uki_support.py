...
SYSTEMS = [
    # 1. 住まい・耐震・環境
    {
        ...
        "dept": "建築指導課 建築指導係",
        "phone": "0964-32-1668",
        "url": "https://www.city.uki.kumamoto.jp/jigyosha/machizukuri/2464787",
        "urlLabel": "公式：木造耐震診断 ↗",
        "icon": "retrofit_check",
        "life": ["working", "senior"],
    ...
    },
    {
        ...
        "dept": "建築指導課 建築指導係",
        "phone": "0964-32-1668",
        "url": "https://www.city.uki.kumamoto.jp/kurashi/sumai/2576107",
        "urlLabel": "公式：ブロック塀安全確保 ↗",
        "icon": "wall",
        "life": ["working", "senior"],
        "family": ["general"],
    ...
    },
    {
        ...
        "phone": "0964-32-1114",
        "url": "https://www.city.uki.kumamoto.jp/kurashi/kankyo_haikibutsu/sonota/",
        "urlLabel": "公式：老朽危険空家除却 ↗",
        "icon": "demolish",
        "life": ["working", "senior"],
        "family": ["general"],
        "housing": ["vacant"],
    ...
    },
    {
        ...
        "dept": "衛生環境課 保健衛生係",
        "phone": "0964-32-1371",
        "url": "https://www.city.uki.kumamoto.jp/kurashi/kankyo/2469645",
        "urlLabel": "公式：浄化槽設置補助 ↗",
        "icon": "septic",
    ...
    },
    {
        ...
        "dept": "衛生環境課 保健衛生係",
        "phone": "0964-32-1371",
        "url": "https://www.city.uki.kumamoto.jp/kurashi/gomi_haikibutsu/gomi/14470",
        "urlLabel": "公式：生ごみ処理容器補助 ↗",
        "icon": "compost",
        "life": ["working", "senior"],
        "family": ["general"],
    ...
    },
    {
        ...
        "dept": "子ども未来課 給付支援係",
        "phone": "0964-32-1404",
        "url": "https://www.city.uki.kumamoto.jp/kosodate/jidofukushi/2431253",
        "urlLabel": "公式：児童手当制度 ↗",
        "icon": "child_benefit",
        "life": ["child_infant", "child_school"],
        "family": ["childcare", "single_parent"],
    ...
    },
    {
        ...
        "dept": "子ども未来課 給付支援係",
        "phone": "0964-32-1404",
        "url": "https://www.city.uki.kumamoto.jp/2012070",
        "urlLabel": "公式：ひとり親等医療費助成 ↗",
        "icon": "single_parent",
    ...
    },
    {
        ...
        "dept": "学校教育課 学務給食係",
        "phone": "0964-32-1811",
        "url": "https://www.city.uki.kumamoto.jp/kosodate/shienseido/",
        "urlLabel": "公式：就学援助制度 ↗",
        "icon": "school_aid",
        "life": ["child_school"],
        "family": ["childcare", "single_parent"],
    ...
    },
    {
        ...
        "dept": "子ども未来課 保育支援係",
        "phone": "0964-32-1404",
        "url": "https://www.city.uki.kumamoto.jp/kosodate/jidofukushi/2013671",
        "urlLabel": "公式：放課後児童クラブ ↗",
        "icon": "afterschool",
        "life": ["child_school"],
        "family": ["childcare", "single_parent"],
        "housing": ["owned_wood", "rental"],
    ...
    },
    {
        ...
        "dept": "学校教育課 総務係",
        "phone": "0964-32-1811",
        "url": "https://www.city.uki.kumamoto.jp/kosodate/nyugaku/2004938",
        "urlLabel": "公式：宇城市奨学金 ↗",
        "icon": "edu_loan",
    ...
    # 3. 健康・出産・女性
    {
        ...
        "dept": "保健センター 保健予防係",
        "phone": "0964-32-1111",
        "url": "https://www.city.uki.kumamoto.jp/kosodate/sodan/2307565",
        "urlLabel": "公式：子育て応援相談・給付 ↗",
        "icon": "heart",
    ...
    },
    {
        ...
        "dept": "保健センター 保健予防係",
        "phone": "0964-32-1111",
        "url": "https://www.city.uki.kumamoto.jp/kosodate/sonota_kosodate/2486130",
        "urlLabel": "公式：不妊先進医療費補助 ↗",
        "icon": "fertility",
    ...
    },
    {
        ...
        "dept": "保健センター 保健予防係",
        "phone": "0964-32-1111",
        "url": "https://www.city.uki.kumamoto.jp/iryo_fukushi/hoken/2424231",
        "urlLabel": "公式：特定健診・がん検診 ↗",
        "icon": "checkup",
        "life": ["working", "senior"],
        "family": ["general", "senior_only"],
        "housing": ["owned_wood", "rental"],
    ...
    # 4. シニア・障がい福祉
    {
        ...
        "dept": "高齢介護課 高齢者支援係",
        "phone": "0964-32-1406",
        "url": "https://www.city.uki.kumamoto.jp/iryo_fukushi/kaigo/2242255",
        "urlLabel": "公式：高齢介護各種申請 ↗",
        "icon": "senior_house",
        "life": ["senior"],
    ...
    },
    {
        ...
        "dept": "高齢介護課 介護保険係",
        "phone": "0964-32-1406",
        "url": "https://www.city.uki.kumamoto.jp/iryo_fukushi/kaigo/2006123",
    ...
    },
    {
        ...
        "phone": "0964-32-1387",
        "url": "https://www.city.uki.kumamoto.jp/iryo_fukushi/fukushi/shogaishafukushi/",
        "urlLabel": "公式：障がい者福祉案内 ↗",
        "icon": "taxi",
        "life": ["senior"],
        "family": ["senior_only", "disability"],
        "housing": ["owned_wood", "rental"],
    ...
    },
    {
        ...
        "dept": "社会福祉課 障がい福祉係",
        "phone": "0964-32-1387",
        "url": "https://www.city.uki.kumamoto.jp/iryo_fukushi/fukushi/shogaishafukushi/2014678",
        "urlLabel": "公式：補装具費支給制度 ↗",
        "icon": "aid_hearing",
    ...
    },
    {
        ...
        "dept": "しごと創生課 商工振興係",
        "phone": "0964-32-1604",
        "url": "https://www.city.uki.kumamoto.jp/jigyosha/shokogyo/",
        "urlLabel": "公式：商工業・融資支援 ↗",
        "icon": "loan_biz",
        "life": ["working"],
        "family": ["general"],
        "housing": ["owned_wood", "rental"],
    ...
    },
    {
        ...
        "dept": "農業振興課 農政係",
        "phone": "0964-32-1644",
        "url": "https://www.city.uki.kumamoto.jp/resource.php?e=43ac65967f1579376fa054102f133dfbf524b5a3cd0f524237e8b084f897fe2f027ecbe83e9e3abbb63b9d3ed0b3e4e9",
        "urlLabel": "公式：新規就農支援要綱 ↗",
        "icon": "farmer",
        "life": ["working", "newlywed"],
        "family": ["general"],
        "housing": ["owned_wood", "rental"],
    ...
    # 7. 熊本地震特別支援
    {
        ...
        "dept": "危機管理課 復興支援係",
        "phone": "0964-32-1798",
        "url": "https://www.city.uki.kumamoto.jp/kurashi/bosai/fukko/",
        "urlLabel": "公式：被災者生活再建支援 ↗",
        "icon": "rebuild",
        "life": ["working", "senior", "newlywed"],

...
SYSTEMS = [
    # 1. 住まい・耐震・環境
    {
        ...
        "dept": "建設下水道課 建設管理係",
        "phone": "0965-52-5862",
        "url": "https://www.town.hikawa.kumamoto.jp/ijuu/kiji0035004/index.html",
        "urlLabel": "公式：耐震診断・改修案内 ↗",
        "icon": "retrofit_check",
        "life": ["working", "senior"],
    ...
    },
    {
        ...
        "dept": "農林振興課 / 地域振興課",
        "phone": "0965-62-2315",
        "url": "https://www.town.hikawa.kumamoto.jp/ijuu/kiji0034083/index.html",
        "urlLabel": "公式：畳表張替助成 ↗",
        "icon": "tatami",
    ...
    },
    {
        ...
        "dept": "建設下水道課 業務管理係",
        "phone": "0965-52-5862",
        "url": "https://www.town.hikawa.kumamoto.jp/ijuu/kiji0035010/index.html",
        "urlLabel": "公式：合併処理浄化槽補助 ↗",
        "icon": "septic",
        "life": ["working", "senior", "newlywed"],
        "family": ["general"],
    ...
    },
    {
        ...
        "dept": "地域振興課 企画調整係",
        "phone": "0965-62-2315",
        "url": "https://www.town.hikawa.kumamoto.jp/ijuu/kiji0034080/index.html",
        "urlLabel": "公式：空き家バンク促進補助 ↗",
        "icon": "vacant",
    ...
    },
    {
        ...
        "dept": "住民福祉課 環境衛生係",
        "phone": "0965-62-2314",
        "url": "https://www.town.hikawa.kumamoto.jp/ijuu/list00812.html",
        "urlLabel": "公式：住まいの支援一覧 ↗",
        "icon": "solar",
        "life": ["working", "senior", "newlywed"],
        "family": ["general"],
        "housing": ["owned_wood"],
    ...
    # 2. 子育て・教育・就学
    {
        ...
        "dept": "住民福祉課 国保年金係",
        "phone": "0965-62-2314",
        "url": "https://www.town.hikawa.kumamoto.jp/ijuu/kiji0034061/index.html",
    ...
    },
    {
        ...
        "dept": "住民福祉課 福祉係",
        "phone": "0965-62-2314",
        "url": "https://www.town.hikawa.kumamoto.jp/ijuu/kiji0034077/index.html",
        "urlLabel": "公式：すこやか赤ちゃん祝金 ↗",
        "icon": "heart",
        "life": ["child_infant"],
        "family": ["childcare"],
        "housing": ["owned_wood", "rental"],
    ...
    },
    {
        ...
        "dept": "住民福祉課 福祉係",
        "phone": "0965-62-2314",
        "url": "https://www.town.hikawa.kumamoto.jp/ijuu/kiji0034062/index.html",
        "urlLabel": "公式：児童手当・子育て給付 ↗",
        "icon": "child_benefit",
        "life": ["child_infant", "child_school"],
        "family": ["childcare", "single_parent"],
        "housing": ["owned_wood", "rental"],
    ...
    },
    {
        ...
        "dept": "教育委員会 学校教育課",
        "phone": "0965-52-5861",
        "url": "https://www.town.hikawa.kumamoto.jp/ijuu/kiji0034082/index.html",
        "urlLabel": "公式：就学援助制度 ↗",
        "icon": "school_aid",
        "life": ["child_school"],
        "family": ["childcare", "single_parent"],
    ...
    },
    {
        ...
        "dept": "教育委員会 総務課",
        "phone": "0965-52-5861",
        "url": "https://www.town.hikawa.kumamoto.jp/ijuu/kiji0034064/index.html",
        "urlLabel": "公式：氷川町奨学金 ↗",
        "icon": "edu_loan",
    ...
    # 3. 健康・出産・女性
    {
        ...
        "dept": "住民福祉課 保健予防係",
        "phone": "0965-62-2314",
        "url": "https://www.town.hikawa.kumamoto.jp/ijuu/kiji0034069/index.html",
        "urlLabel": "公式：出産・子育て支援 ↗",
        "icon": "heart",
    ...
    },
    {
        ...
        "dept": "住民福祉課 保健予防係",
        "phone": "0965-62-2314",
        "url": "https://www.town.hikawa.kumamoto.jp/ijuu/kiji0034065/index.html",
        "urlLabel": "公式：住民検診・特定健診 ↗",
        "icon": "checkup",
        "life": ["working", "senior"],
        "family": ["general", "senior_only"],
        "housing": ["owned_wood", "rental"],
    ...
    # 4. シニア・障がい福祉
    {
        ...
        "dept": "地域振興課 / 住民福祉課",
        "phone": "0965-62-2315",
        "url": "https://www.town.hikawa.kumamoto.jp/ijuu/kiji0035031/index.html",
        "urlLabel": "公式：福祉タクシー助成 ↗",
        "icon": "taxi",
        "life": ["senior"],
    ...
    },
    {
        ...
        "phone": "0965-62-2314",
        "url": "https://www.town.hikawa.kumamoto.jp/ijuu/kiji0035032/index.html",
        "urlLabel": "公式：配食サービス ↗",
        "icon": "meal",
        "life": ["senior"],
        "family": ["senior_only"],
    ...
    # 5. 移住・新婚・地域
    {
        ...
        "dept": "地域振興課 企画調整係",
        "phone": "0965-62-2315",
        "url": "https://www.town.hikawa.kumamoto.jp/ijuu/kiji0034052/index.html",
        "urlLabel": "公式：移住体験住宅 ↗",
        "icon": "moving",
        "life": ["working", "newlywed"],
    ...
    # 6. 産業・農業・創業
    {
        ...
        "dept": "農林振興課 / 地域振興課",
        "phone": "0965-62-2315",
        "url": "https://www.town.hikawa.kumamoto.jp/ijuu/kiji0034078/index.html",
        "urlLabel": "公式：商工振興・創業支援 ↗",
        "icon": "startup",
        "life": ["working"],
        "family": ["general"],
        "housing": ["owned_wood", "rental"],
    ...
    },
    {
        ...
        "dept": "農林振興課 農政係",
        "phone": "0965-62-2315",
        "url": "https://www.town.hikawa.kumamoto.jp/ijuu/kiji0034075/index.html",
        "urlLabel": "公式：就農・担い手支援 ↗",
        "icon": "farmer",
        "life": ["working", "newlywed"],
        "family": ["general"],
        "housing": ["owned_wood", "rental"],
    ...
    },
    {
        ...
        "dept": "建設下水道課 建築係",
        "phone": "0965-52-5862",
        "url": "hikawa-support.html#repair",
        "urlLabel": "応急修理制度の詳細 ↗",
    ...
    },
    {
        ...
        "dept": "住民福祉課 福祉係",
        "phone": "0965-62-2314",
        "url": "hikawa-support.html#catalog-housing",
        "urlLabel": "被災者生活再建支援金 ↗",
        "icon": "rebuild",
        "life": ["working", "senior", "newlywed"],
        "family": ["general", "senior_only"],
    ...
    },
    {
        ...
        "phone": "0965-62-2313",
        "url": "hikawa-support.html#deadlines",
        "urlLabel": "減免・猶予手続き案内 ↗",
        "icon": "tax_relief",
        "life": ["working", "senior"],
        "family": ["general", "senior_only"],

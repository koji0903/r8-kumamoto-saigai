...
if (fix) {
  run("node", ["tools/build-priority-support.mjs"], "5市町支援制度まとめの生成");
  run("node", ["tools/build-home-topics.mjs"], "トップページトピックスの生成");
  run("node", ["tools/build-seo.mjs"], "SEO・サイト内検索の生成");
}
run("node", ["tools/build-priority-support.mjs", "--check"], "5市町支援制度まとめ生成物");
...
const syntaxTargets = [
  ...
  "yatsushiro-loan.js",
  "uto-jizokuka.js",
  "kumamoto-saishuppatsu.js",
  "uto-support.js",
  "uto-public-services.js",
  "uki-living-support.js",
  "hikawa-living-support.js",
  "yatsushiro-living-support.js",
  "yatsushiro-safetynet4.js",

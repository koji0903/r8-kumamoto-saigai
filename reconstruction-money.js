(() => {
  ...
  const needs = {
    ...
    housing: { title: "住宅の修理費・再建費が心配", intro: "お金の問題と住まいの支援を分けずに確認します。", checks: ["住宅の被害を写真に残していますか", "修理前に市町村へ確認しましたか", "罹災証明の手続きを確認しましたか"], links: [["宇土市の住まい・再建支援を見る", "uto-housing.html"], ["市町村の公的情報を確認する", "municipalities.html"]] },

(()=>{
  ...
  const facilities=[
    ...
    {id:"ouda",name:"網田支所",address:"宇土市下網田町1819",lat:32.663006,lng:130.545410,ticket:false,selfService:true,period:"8月10日（月）〜9月30日（水）",closed:"定例の中止日なし（満杯時は一時中止）",types:["glass","fabric"],count:"4品目のみ",note:"ガラス類、陶磁器類（せともの）、瓦、布類（布団等）の4品目のみ",flow:"書類は不要です。ガラス類・陶磁器類・瓦は袋から出し、設置されたコンテナへ直接投入してください。"},
    {id:"amitsu",name:"網津支所",address:"宇土市網津町1991-1",lat:32.696949,lng:130.604156,ticket:false,selfService:true,period:"8月10日（月）〜9月30日（水）",closed:"定例の中止日なし（満杯時は一時中止）",types:["glass","fabric"],count:"4品目のみ",note:"ガラス類、陶磁器類（せともの）、瓦、布類（布団等）の4品目のみ",flow:"書類は不要です。ガラス類・陶磁器類・瓦は袋から出し、設置されたコンテナへ直接投入してください。"}
  ];
  const locations=[

(() => {
  ...
  const topics = {
    ...
    paperwork:{label:"証明・手続き",prompt:"罹災証明や申請が分からない",title:"被害の証明や申請で困っていますか？",lead:"制度名を知らなくても、必要な手続きの入口を確認できます。",checks:["被害の状況を写真に残しているか","お住まいの市町村の案内を確認したか","申請前に必要な書類を確認したか"],links:[{label:"証明・申請を詳しく整理する",href:"reconstruction-documents.html"},{label:"制度・生活支援を見る",href:"guide.html"}]},

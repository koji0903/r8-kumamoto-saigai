(() => {
  ...
  const topics = {
    housing:{label:"住まい",prompt:"家に住めない・修理したい",title:"住まいのことで困っていますか？",lead:"家に住めない、修理したい、仮の住まいを探している方へ。",checks:["今の家で安全に生活できるか","修理が必要な場所を記録できているか","市町村へ相談できているか"],links:[{label:"応急仮設住宅の整備・募集状況を見る",href:"temporary-housing.html"},{label:"り災証明書の判定と支援を確認する",href:"risai-certificate.html"},{label:"宇土市の住まい支援を確認する",href:"uto-housing.html"},{label:"自治体別情報を見る",href:"municipalities.html"}]},
    money:{label:"お金・支払い",prompt:"生活費や支払いが心配",title:"生活費や支払いが心配ですか？",lead:"収入や毎月の支払いへの影響を、一つずつ整理します。",checks:["収入や仕事に変化があるか","住まいにも被害があるか","続いている支払いに心配があるか"],links:[{label:"お金・支払いを詳しく整理する",href:"reconstruction-money.html"},{label:"生活再建支援金・支援制度ガイドを見る",href:"guide.html"},{label:"自治体の減免・給付窓口を見る",href:"municipalities.html"}]},
    paperwork:{label:"証明・申請",prompt:"罹災証明や申請が分からない",title:"被害の証明や申請で困っていますか？",lead:"制度名を知らなくても、必要な手続きの入口を確認できます。",checks:["被害の状況を写真に残しているか","お住まいの市町村の案内を確認したか","申請前に必要な書類を確認したか"],links:[{label:"り災証明の判定と支援を確認する",href:"risai-certificate.html"},{label:"証明・申請を詳しく整理する",href:"reconstruction-documents.html"},{label:"制度・生活支援を見る",href:"guide.html"},{label:"自治体の証明書窓口を確認する",href:"municipalities.html"}]},
    health:{label:"健康・介護",prompt:"健康・介護のことが心配",title:"健康や介護のことで心配がありますか？",lead:"本人や家族の健康、高齢者、介護、障がい、心のケアについて整理します。",checks:["いつもの通院や薬を続けられているか","介護や福祉サービスに変化があるか","本人や家族が一人で抱え込んでいないか"],links:[{label:"健康・介護を詳しく整理する",href:"reconstruction-health-care.html"},{label:"国・県の医療・福祉・公的情報を見る",href:"official.html"}]},
    family:{label:"子ども・家族",prompt:"子どもや家族のことで困っている",title:"子どもや家族のことで困っていますか？",lead:"学校、保育、学用品、子育て、家族の生活について整理します。",checks:["学校や保育の予定を確認できているか","子どもの生活用品に不足があるか","家族それぞれに別の困りごとがないか"],links:[{label:"子ども・家族を詳しく整理する",href:"reconstruction-family.html"},{label:"国・県の子育て・教育情報を見る",href:"official.html"}]},
    work:{label:"仕事・事業",prompt:"仕事や事業への影響がある",title:"仕事や事業を続けることで困っていますか？",lead:"働くことへの影響と、店舗・会社・事業の再開を分けて整理します。",checks:["雇用や収入に影響があるか","店舗、設備、在庫に被害があるか","仕事と住まいの両方に影響があるか"],links:[{label:"仕事・事業を詳しく整理する",href:"reconstruction-work-business.html"},{label:"事業者支援・雇用等の公的情報を見る",href:"official.html"}]},
    primary:{label:"農業・漁業",prompt:"農業・漁業への影響がある",title:"農業・漁業の再開で困っていますか？",lead:"生産設備、農地、漁具、経営への影響を整理します。",checks:["農地、船、設備などに被害があるか","生産や出荷を続けられるか","住まいや生活費にも影響があるか"],links:[{label:"農業・漁業を詳しく整理する",href:"reconstruction-agriculture-fishery.html"},{label:"農林水産関連の公的支援情報を見る",href:"official.html"}]},
    daily:{label:"暮らし・移動",prompt:"車・移動・日常生活で困っている",title:"移動や日常生活で困っていますか？",lead:"車、交通、ごみ、水道、日用品など、毎日の暮らしへの影響を整理します。",checks:["移動する手段を確保できているか","水道やごみなど自治体情報を確認したか","必要な日用品が不足していないか"],links:[{label:"市町村の公式発信（生活・ごみ・ライフライン）を見る",href:"municipalities.html?tab=updates"},{label:"自治体別情報を見る",href:"municipalities.html"},{label:"国・県のライフライン情報を見る",href:"official.html"}]}
  };
  ...
  const withMunicipality=href=>{
    ...
    if(/^municipality-updates\.html$/.test(href)||/^municipalities\.html$/.test(href)||/^municipalities\.html\?/.test(href)){
      const name=municipalityNames[currentMunicipality.replace(/^municipality_/,"")];
      if(!name)return href;
      const delimiter=href.includes("?")?"&":"?";
      return `${href}${delimiter}name=${encodeURIComponent(name)}`;
    }
    return href;
  };

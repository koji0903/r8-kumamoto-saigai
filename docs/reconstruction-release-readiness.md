...
- P3: A-01/B-01/C-01の実利用者テストと、端末・回線別の継続改善。
...
A-01/B-01/C-01の実利用者テストは未実施。技術的公開を妨げないが、行政誤認、「確認中」の理解、高齢者操作、支援者による判定誤認は実地確認が必要。Vercel管理画面の設定値自体はリポジトリ外のため、公開直後にdeployment SHAを人が照合する。
